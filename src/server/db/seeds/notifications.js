...
const dbname = prefix('notifications');

const readFile = util.promisify(fs.readFile);
const jsonDir = path.join(__dirname, 'notifications');
const schemasDir = path.join(__dirname, '../../schemas/db/notifications');

const notificationSeeding = async () => {
  try {
...
if (require.main === module) notificationSeeding();

module.exports = notificationSeeding;
