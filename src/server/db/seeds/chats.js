...
const jsonDir = path.join(__dirname, 'chats');
const schemasDir = path.join(__dirname, '../../schemas/db/chats');

const chatsSeeding = async () => {
  try {
...
if (require.main === module) chatsSeeding();

module.exports = chatsSeeding;
